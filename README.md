...
**AGI Summit 2026 Hackathon — 🥇 1st place, Cotal.ai sponsor track**
...
| `overview.html` | The interactive submission page — 3 tabs, clickable inspector, task simulation, 26-scene narrated walkthrough with per-slide explainers (incl. the v0.4 arc: what our benchmark provoked upstream, what we found inside their fix, how we switched it on — and Run 11's live numbers on the board) — deployed at the link above |
