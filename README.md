...
| `overview.html` | The interactive submission page — 3 tabs, clickable inspector, task simulation, 20-scene narrated walkthrough with per-slide explainers — deployed at the link above |
