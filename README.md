...
| **Two upstream PRs** | Both connectors ported into the Cotal monorepo's conventions, built in-tree against connector-core 0.12.0 — branches on `Wally-Ahmed/Cotal`, bodies in [`docs/cotal-pr-drafts.md`](docs/cotal-pr-drafts.md) |
