...
Opus behind Claude Code + Max. This tool is the front-door to the one you pay for. And you
shouldn't have to buy API credits on top of a subscription you already have: the planner
brain can ride a first-party OAuth login (Sign in with ChatGPT, or a Nous Portal account)
instead of a metered key.
